var h = (Math.max(document.documentElement.clientHeight, window.innerHeight || 0) * 28) / 100;
var w = (Math.max(document.documentElement.clientWidth, window.innerWidth || 0) * 17) / 100;
